...
public class AllNewsLoader extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("Inside all news loader");
        try {
            ...
            response.sendRedirect("content_pages/News/compose_news.jsp");
            System.out.println("All NewsDepartments Got");
            
            executorService.shutdown();
        } catch (NullPointerException e) {
            System.err.println("AllNewsLoader: null value is thrown=" + e.getMessage());
        } catch (Exception e) {
            System.err.println("Exceptoin in AllNewsLoader:=" + e.getMessage());
        }
    }
