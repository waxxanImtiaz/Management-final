          ...
          <div class="box box-primary">
            ...
            <form role="form"  name="add_depart_form">
              <div class="box-body">
                  ...
                  <label for="subjectName">Book Name</label>
                  <input type="text" class="form-control" id="bookName" placeholder="Enter book name">
              </div>
                  <div class="form-group">
                  <label for="subjectName">Book Author</label>
              ...
              <div class="box-footer">
                  <button type="submit" class="btn btn-primary" onclick="return checkBookAddForm()" >Submit</button>
              </div>
            </form>
          </div>
        </div>
