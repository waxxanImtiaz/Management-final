                                            ...
                                            <div>
                                                <table class="huTable" border="0" width="100%" cellspacing="0" cellpadding="0">
                                                    ...
                                                    <div>
                                                        ...
                                                        <%
                                                            Students personalInfo = (beans.Students) session.getAttribute("personalInfo");
                                                            List<LibraryDetails> libraryDetails = (List<LibraryDetails>) session.getAttribute("libraryDetails");
                                                        %>
                                                        <table class="huTable" border="0" width="100%" cellspacing="0" cellpadding="10">
                                                            ...
                                                            <align="center" width="780">
                                                                ...
                                                                <tr>
                                                                    <td colspan="3" width="295"  height="25"><a href="${pageContext.request.contextPath}/LibraryBooksLoader"><center> Books List</center></a></td></tr>	
                                                                <tr>
                                                                    <td colspan="3" width="295"  height="25">&nbsp; </td>
                                                                </tr>
