...
<tbody>
 ...
 <align="center" width="780">
         ...
         <td>&nbsp; Roll no</td><td>&nbsp; Book Name</td><td>&nbsp; Issue Date</td><td>&nbsp; Return Date</td></td>
          </tr>
          <% for(LibraryDetails book : books ) {%>
          <tr>
          <td > <%=book.getName() %></td> <td>&nbsp;<%=book.getRollNum() %></td><td > <%=book.getBookName() %></td><td>&nbsp; <%=book.getIssueDate() %> </td ><td>&nbsp;  <%=book.getReturnDate() %> </td >
          </tr>
          <% } %>
