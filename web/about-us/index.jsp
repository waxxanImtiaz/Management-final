                            ...
                            <div id="access" role="navigation">
                                <div class="menu-header"><ul id="menu-main-menu-1" class="menu">
                                        ...
                                        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-37"><a href="miscellaneous.jsp"> Miscellenous </a>
                                            <ul class="sub-menu">
                                                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-9783"><a href="${pageContext.request.contextPath}/LibraryManager">News</a></li>
                                                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-515"><a href="message.jsp">Messege</a>
                            ...
                            <div id="post-22" class="post-22 page type-page status-publish has-post-thumbnail hentry">
                                ...
                                <div class="entry-content">
                                    <div class="link_images">
                                        <div class="menu_item col4"><a href="personelInfo.jsp" ><h2 class="red white" style="bottom:0">Personel Information</h2><img class="alignnone size-full wp-image-84" src="../wp-content/uploads/2014/09/personel.jpg" alt="vision-values" width="256" height="165" /></a></div><br />
