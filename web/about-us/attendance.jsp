                                                        ...
                                                        <table class="huTable" border="0" width="100%" cellspacing="0" cellpadding="10">
                                                            ...
                                                            <align="center" width="780">
                                                                ...
                                                                <% //print subject attendance
                                                                    ...
                                                                    for (Map.Entry<String, Integer> map : attendance.entrySet()) {
                                                                        //count total
                                                                        count++;
                                                                        String key = map.getKey().toString();

                                                                        Integer value = map.getValue();
                                                                        Subjects subject = theorySubjects.get(index);
                                                                        int i = 0;
                                                                        String subj = null;
                                                                        while (i < theorySubjects.size()) {
                                                                            subj = theorySubjects.get(i).getSubjectName();
                                                                            if (subj != null && subj.equalsIgnoreCase(key)) {
                                                                                tempSubject = theorySubjects.get(i);
                                                                                break;
                                                                            }
                                                                            i++;
                                                                        }//END OF WHILE LOOP
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="3" width="196">   <%= percentage%>% </td>
                                                                </tr>
