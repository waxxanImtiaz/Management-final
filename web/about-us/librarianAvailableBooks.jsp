            ...
            <div class="inner_wrap">
                <div id="header">
                    ...
                    <%
                        ...
                        List<LibraryBooks> libraryBooks = (List<LibraryBooks>) session.getAttribute("libraryBooks");
                            ...
                            <div id="access" role="navigation">
                                <div class="menu-header"><ul id="menu-main-menu-1" class="menu">
                                        ...
                                        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-50"><a href="#"> Books </a>
                                            <ul class="sub-menu">
                                                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-975"><a href="#">Available Books</a>

                                                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-975"><a href="#">Issued Books</a>
                ...
                <div id="main">
                    ...
                    <div id="container">
                                                    ...
                                                    <div>
                                                        <table class="huTable" border="0" width="100%" cellspacing="0" cellpadding="10">
                                                            ...
                                                            <align="center" width="780">
                                                                <tr><td colspan="4" width="295"> Available Books</td></tr>
                                                                </tr>
                                                                <tr>
                                                                    <td>&nbsp; Book Name</FONT>
                                                                    <td>&nbsp; Book Author</td><td>&nbsp; Book Code</td><!--<td>&nbsp; Number of books</td> --></td>
                                                                </tr>
                                                                <% for (LibraryBooks books : libraryBooks) {%>
                                                                <tr>
                                                                    <td > <%=books.getBookName()%></td><td>&nbsp;  <%=books.getAuthor()%> </td><td>&nbsp;  <%=books.getId()%> </td ><!-- <td>&nbsp;  - - </td > -->
                                                                </tr>
                                                                <% }%>
                                                                <tr>
                                                                    <td colspan="4" >&nbsp;    </td>
                        ...
                        <div id="primary" class="widget-area" role="complementary">
                            ...
                            <ul class="tb_side">
                                <li class="page_item page-item-51 page_item_has_children"><a><a href="Librarian.jsp"> Books Issuance Form</a>
                                        <ul class='children'>
