                                                ...
                                                <table class="huTable" border="0" width="100%" cellspacing="0" cellpadding="0">
                                                    ...
                                                    <div>
                                                        ...
                                                        <%
                                                            ...
                                                            List<Notifications> notification = (List<Notifications>) session.getAttribute("notifications");
                                                        %> 
                                                        <table class="huTable" border="0" width="100%" cellspacing="0" cellpadding="10">
                                                            <tbody>
                                                            <align="center" width="780">
                                                                <tr><td colspan="5" width="197"><font> Notifications </FONT></td> </tr>    
                                                                <tr>
                                                                ...
                                                                <% for(Notifications n : notification){ %>
                                                                <tr>
