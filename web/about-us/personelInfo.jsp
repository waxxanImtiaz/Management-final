        ...
        <div id="wrapper" class="hfeed">
            <div class="inner_wrap">
                ...
                <%
                    ...
                    beans.MatricInformation matric = (beans.MatricInformation) session.getAttribute("matric");
                    beans.Students personalInfo = (beans.Students) session.getAttribute("personalInfo");
                    beans.Intermediate intermediate = (beans.Intermediate) session.getAttribute("inter");
                                                        ...
                                                        <table class="huTable" border="0" width="100%" cellspacing="0" cellpadding="10">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><%=matric.getBoard()%></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Intermediate</td>
                                                                    <td><%=intermediate.getBoard()%></td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    </div>
