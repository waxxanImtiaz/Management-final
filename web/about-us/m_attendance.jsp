                                ...
                                <div class="menu-header"><ul id="menu-main-menu-1" class="menu">
                                        ...
                                        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-50"><a href="academics.jsp"> Academics </a>
                                            <ul class="sub-menu">
                                                ...
                                                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-975"><a href="#">Lectures</a>
                                                    <ul class="sub-menu">
                                        ...
                                        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-7300"><a href="m_attendance.jsp"> Attendance </a>
                                            <!---->
                                            <ul class="sub-menu">
                                                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-8788"><a href="${pageContext.request.contextPath}/SemesterChecker?semester=1st" >1st Semister</a></li>
                                                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-8787"><a href="${pageContext.request.contextPath}/SemesterChecker?semester=2nd">2nd Semister</a></li>
                                                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-8791"><a href="${pageContext.request.contextPath}/SemesterChecker?semester=3rd">3rd Semister</a></li>
                                                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-8790"><a href="${pageContext.request.contextPath}/SemesterChecker?semester=4th">4th Semister</a></li>
                                                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-8789"><a href="${pageContext.request.contextPath}/SemesterChecker?semester=5th">5th Semister</a></li>
                                                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-8790"><a href="${pageContext.request.contextPath}/SemesterChecker?semester=6th">6th Semister</a></li>
                                                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-8789"><a href="${pageContext.request.contextPath}/SemesterChecker?semester=7th">7th Semister</a></li>
                                                <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-7306"><a href="${pageContext.request.contextPath}/SemesterChecker?semester=8th">8th Semister</a></li>
                                            </ul> 
                                        </li>
                            ...
                            <div id="post-22" class="post-22 page type-page status-publish has-post-thumbnail hentry">
                                ...
                                <div class="entry-content">
                                    <div class="link_images">
                                        <div class="menu_item col4"><a href="${pageContext.request.contextPath}/SemesterChecker?semester=1st" ><h2 class="red white" style="bottom:0">1st Semister</h2><img class="alignnone size-full wp-image-84"  alt="ist semister" width="256" height="165" /></a></div><br />
                                        <div class="menu_item col4"><a href="${pageContext.request.contextPath}/SemesterChecker?semester=2nd" ><h2 class="blue white" style="bottom:0">2nd Semister</h2><img class="alignnone size-full wp-image-88" alt="2nd semister" width="256" height="165" /></a></div><br />
                                        <div class="menu_item col4"><a href="${pageContext.request.contextPath}/SemesterChecker?semester=3rd" ><h2 class="purple indigo" style="bottom:0">3rd Semister</h2><img class="alignnone size-full wp-image-85" alt="3rd" width="257" height="165" /></a></div><br />
                                        <div class="menu_item col4"><a href="${pageContext.request.contextPath}/SemesterChecker?semester=4th" ><h2 class="yellow indigo" style="bottom:0">4th Semister</h2><img class="alignnone size-full wp-image-85"  alt="4th" width="257" height="165" /></a></div><br />
                                        <div class="menu_item col4"><a href="${pageContext.request.contextPath}/SemesterChecker?semester=5th" ><h2 class="purple indigo" style="bottom:0">5th Semister</h2><img class="alignnone size-full wp-image-84" alt="5th" width="256" height="165" /></a></div><br />
                                        <div class="menu_item col4"><a href="${pageContext.request.contextPath}/SemesterChecker?semester=6th" ><h2 class="yellow indigo" style="bottom:0">6th Semister</h2><img class="alignnone size-full wp-image-88"  alt="6th" width="256" height="165" /></a></div>
                                        <div class="menu_item col4"><a href="${pageContext.request.contextPath}/SemesterChecker?semester=7th" ><h2 class="blue white" style="bottom:0">7th Semister</h2><img class="alignnone size-full wp-image-84"  alt="7th" width="256" height="165" /></a></div><br />
                                        <div class="menu_item col4"><a href="${pageContext.request.contextPath}/SemesterChecker?semester=8th" ><h2 class="red white" style="bottom:0">8th Semister</h2><img class="alignnone size-full wp-image-85"  alt="8th" width="257" height="165" /></a></div><br />
