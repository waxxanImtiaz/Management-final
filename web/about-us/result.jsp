                                                        ...
                                                        <table class="huTable" border="0" width="100%" cellspacing="0" cellpadding="10">
                                                            ...
                                                            <align="center" width="780">
                                                                ...
                                                                <% for (StudentSemesterResult result : theoryResult) {
                                                                        ...
                                                                        Subjects theorySubject = null;

                                                                        for (Subjects thoerySubs : theorySubjects) {
                                                                            if (thoerySubs.getSubjectName().equalsIgnoreCase(subject)) {
                                                                                theorySubject = thoerySubs;
                                                                                break;
                                                                            }
                                                                        }//end of loop
%>
...
//                                                                        }
//                                                                        if (practResult != null) {
//                                                                            out.println("practicalResult subject=" + practResult.getSubject());
//                                                                        }
                                                                    %>       
                                                                    <!--====practical result -->
